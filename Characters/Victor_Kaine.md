...
Victor war ein gefürchteter Interim-Manager namens "The Chainsaw", bekannt für rücksichtslose Effizienz. Menschen waren für ihn Zahlen, keine Individuen. Er empfand keinen Sadismus, aber auch keine Empathie—alles war ROI-Kalkulation.

### Project Cobalt & Der Verrat

Er wurde zum Sündenbock für einen Skandal um Konfliktmineralien ("Project Cobalt"), bei dem 47 Menschen starben, darunter Kinder in kongolesischen Minen. Victor hatte die Befehle unterschrieben, aber erst später von den Toten erfahren.

**Die eine selbstlose Tat**: Statt unterzutauchen, kompilierte Victor Beweise gegen die Komplizenschaft des Vorstands und lieferte sie an die Anwälte der Opfer. Überlebenschance: 15%. Er wusste, dass er dafür sterben würde—und akzeptierte es als positiven ROI (200 zukünftige Todesfälle verhindert).

Drei Tage später wurde er von einem professionellen Attentäter ermordet ("Herzinfarkt").
...
Victor erwachte im Dungeon—nicht gerettet, sondern **rekrutiert**.
...
- **Utilitarist**: Berechnet ROI für alles, inklusive Menschenleben.
- **Vergrabene Menschlichkeit**: Angetrieben von Project-Cobalt-Schuld (Ch 40 Flashback), lehnt "verschwenderische" Tode ab, behauptet aber, es sei nur Effizienz.
- **Strategischer Denker**: Plant mehrere Züge voraus; nutzt Information, Leverage und ökonomischen Druck statt direkter Konfrontation.
- **Emotionale Unterdrückung**: Empfindet Emotionen, zeigt sie aber nicht. "Just math."

### Motivation

**Offiziell**: Profit, Effizienz, feindliche Übernahme des Konsortiums.  
**Inoffiziell**: Vermeidung sinnloser Tode (Project Cobalt-Trauma). Will beweisen, dass seine Methoden besser sind als die des Konsortiums.

### Verhaltensweise

- Spricht in Business-Jargon und Corporate-Euphemismen
- Kämpft nie fair—nutzt Verträge, Leverage, Informationsasymmetrie
- Betrachtet moralische Dilemmata als Optimierungsprobleme
- Respektiert Kompetenz; verachtet Inkompetenz
...
|-----------|-----------|--------|
| **Sniv** | COO / Employee #1 | Loyalster Mitarbeiter; Victor beschützt ihn |
| **Asterion** | CSO / General | Professioneller Respekt; Victor gab ihm Sinn |
| **Dungeon Core (Nova)** | Geschäftspartner | 50/50 Partnership; gegenseitiger Vorteil |
| **Hestia** | Konsortium-Liaison / Mentor | Von Rivalin zur Mentorin; respektiert Victors Erfolg |
...
| 90-95 | Arc Finale Prep | +4,000 | 38,485 | 10 |
| 96-99 | Church Conflict | +8,000 | 46,485 | **11-13** |
| 100 | Quest: The Million (Arc Complete) | +54,000 | 100,485 | **14** |
...
| Fähigkeit | Effekt |
|-----------|--------|
| **[Performance Review]** | Analysiert Stats/Wert/institutionelle Schwächen |
| **[Aggressive Negotiations]** | Psychischer Druck/Paralyse (verstärkt durch Church/Executor-Verhandlungen) |
| **[Asset Liquidation]** | Konvertiert immobilisierte Ziele zu Gold |
| **[Contract Binding]** | Magische Durchsetzung von Vertrags-Bedingungen |
| **[Market Arbitrage]** | Ausnutzung von Preisineffizienzen über dimensionale Märkte |
...
1. **Analytisches Genie**: Sieht Muster und Schwächen, die andere übersehen
2. **Ökonomische Kriegsführung**: Meister der feindlichen Übernahmen
3. **Informationskrieg**: Nutzt Asymmetrie als Waffe
4. **Konsortium-Zugang**: Galactic Exchange, Shell Companies, Dimensional Trade
5. **Politisches Netzwerk**: Church, Merchant Guild, Crown, Sterling

### Schwächen

1. **Körperlich schwach**: Verliert direkten Kampf gegen Level 8+ Kämpfer
2. **Emotional unterdrückt**: Project Cobalt-Trauma kann ausgenutzt werden
3. **Überkonfident**: Unterschätzt manchmal emotionale Faktoren
4. **Konsortium-Abhängigkeit**: Termination möglich bei Regelverstößen
5. **Zeitdruck**: Deadlines (30 Tage Arc 1, BROKEN CROWN 2 Wochen)

---

## Rolle im Team

- **Funktion**: CEO, Stratege, Verhandlungsführer
- **Kompetenzen**: Ökonomische Kriegsführung, Verträge, Institutional Navigation
- **Verantwortung**: Alle wichtigen Entscheidungen, Expansion, Konsortium-Beziehungen
...
- Short-sold Syndicate Bonds
- Malphas triggerte Explosion; Victor liquidierte explodierenden Asset (45.000 GP)
...
- Southern Coalition Miracle-Deal (60 Miracles)
- Church-Partnership (50/50 → 15% Brokerage)
- Executor Veyra-Audit überlebt via Precedent Defense
- Kaufte illegalen Dungeon Core Seed (85k GP)
- Verkaufte Seed an Gorvak für 220k GP
- **ERFOLG**: 1.022.000 GP in 23 Tagen (Konsortium-Rekord)
- Probation aufgehoben, permanente Residency gewährt
- **Transformation**: Von broke Dungeoneer zu etabliertem Tycoon
...
- Strategie: Crown Territory-Loophole nutzen (Dungeon-Entrance-Shop)
...
- **Total Cost**: 95k GP
- Council Vote morgen (projected 7-4 Approval)
- **KIRA URGENT**: BROKEN CROWN Deadline 72 Stunden
...
- **Succession Protocol 2.0**: Marcus (Acting CEO), Sniv (COO), Asterion (Security), Lysander (Compliance), Nova (Capital Allocation)
- **Oakhaven Status**: 87% autonomous, 5k GP weekly revenue, self-sustaining
- **Deployment**: 96 hours (4 days). Pre-mission briefing tomorrow, Orbital Platform Sigma.
